...
//                                 child: ClipOval(
//                                   child: Center(
//                                     child: (FeedsData![index].profilePicture ==
//                                                 "" ||
//                                             FeedsData![index].profilePicture ==
//                                                 null ||
//                                             FeedsData![index].profilePicture ==
//                                                 "undefined")
//                                         ? Icon(
...
//                                           FeedsData![index].feedImage == null)
//                                       ? null
//                                       // Icon(
//                                       //     Icons.person,
//                                       //     color: Colors.grey.shade600,
...
//                                         onTap: () {
//                                           setState(() {
//                                             if (FeedsData![index].likedUser ==
//                                                 Strings.myprofile![0].userId) {
//                                               unLike(FeedsData![index].feedId,
...
//                                           // ),
//                                           child: (FeedsData![index].likedUser !=
//                                                   Strings.myprofile![0].userId)
//                                               ? Icon(
